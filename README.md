...
- **Three Capture Modes:**
  - **Link Only** - Capture page URL and title
  - **Selection** - Capture selected text and images
  - **Full Page** - Capture entire page content
...
- **Keyboard Shortcuts:**
  ...
  - `Cmd+Shift+Y` (Mac) / `Ctrl+Shift+Y` (Windows) - Quick capture selection
...
1. Open `extension/icons/generate-icons.html` in a browser
...
4. Select capture mode (Link, Selection, or Full Page)
5. Choose destination (Journal or specific page)
6. Add optional tags
...
- **Default Capture Mode** - Link, Selection, or Full Page
